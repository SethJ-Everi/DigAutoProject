            ...
            try:
                ...
                for game in all_games:
                    ...
                    if game not in games_operatorSheet_file:
                        missing_in.append('Missing in Operator Wager Config File')
                ...
                for wager_column in wagerAudit_StagingFile.columns:
                    ...
                    if (
                        ...
                        audit_results_wagers[f"{wager_column}\n(Wager Staging Audit File): "] = wagerAudit_StagingFile[wager_column]
                        audit_results_wagers[f"{wager_column}\n(Wager Production Audit File): "] = wagerAudit_ProductionFile[wager_column]
                ...
                audit_results_wagers['Game'] = wagerAudit_StagingFile['Game'].values
